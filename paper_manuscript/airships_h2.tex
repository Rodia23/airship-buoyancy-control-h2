...
\item \textbf{Three of the four evaluated airships} achieve energetic self-sufficiency through solar regeneration under average Lima irradiance, recovering the H\textsubscript{2} consumed per delivery in under one day. The Zeppelin~NT is the exception: its limited upper-surface coverage ($1{,}260$~m\textsuperscript{2} of usable photovoltaic area, against $10{,}800$~m\textsuperscript{2} for the LZ~129 Hindenburg) extends the recovery cycle to approximately 29.5~h (1.23~days), beyond the 24-hour delivery cadence --- the regenerative cycle is naturally optimised for large-scale platforms.
